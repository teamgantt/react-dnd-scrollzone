...
function createScrollingComponent(WrappedComponent) {
  var ScrollingComponent = function (_Component) {
    ...
    _createClass(ScrollingComponent, [{
      ...
      value: function componentDidMount() {
        ...
        this.container = this.props.scrollContainer || (0, _reactDom.findDOMNode)(this.wrappedInstance);
  ...
  ScrollingComponent.propTypes = {
    ...
    scrollContainer: _propTypes2.default.instanceOf(typeof Element !== 'undefined' ? Element : Object)
  };
